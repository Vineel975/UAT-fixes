    ...
    return (
      <div className="space-y-3">
        <div className="grid grid-cols-1 gap-x-3 gap-y-2 md:grid-cols-2">
          ...
          {/* Availed Accommodation — from Spectra ddlReceivedAccomodation */}
          <div className="space-y-1">
            <div className="flex items-center justify-between gap-3">
          ...
          {/* Approved Accommodation — Day-care for cataract, from Spectra otherwise */}
          <div className="space-y-1">
            <div className="flex items-center justify-between gap-3">
              <Label className="text-xs text-muted-foreground">Approved Accommodation</Label>
            </div>
            <Input
              value={approvedAccom ?? "Day-care"}
              disabled
              readOnly
